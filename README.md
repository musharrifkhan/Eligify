...
Instead of searching manually, users:

1. Answer a few simple questions *or*
2. Type a natural query (like “I am a student from Haryana”)
...
Users provide basic details like:

* State
* Income range
* Occupation (student, employed, etc.)
* Other relevant criteria

Our system matches these inputs against stored eligibility rules.

---

### 2. Personalized Results

Instead of overwhelming users with all schemes, Eligify:

* Filters only relevant ones
* Prioritizes high-match schemes
* Keeps results simple and useful

---

### 3. Clear Scheme Breakdown

Each scheme is explained in a practical way:
...
* A working eligibility questionnaire
* A dataset of selected real schemes
...
* Help users take action, not just read information
